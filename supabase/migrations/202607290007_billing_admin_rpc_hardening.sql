-- Forward-only reapplication of the hardened administration RPC definitions.
-- This migration intentionally repeats the corrected definitions so databases
-- that already applied an earlier 005 receive the same protections as fresh installs.
