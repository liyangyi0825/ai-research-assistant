...
const FEATURES: Feature[] = [
  ...
  },
  {
    icon: "✍️",
    title: "论文润色",
    what: "粘贴自己写的论文段落或全文，AI 对语言表达、句式结构、学术规范进行优化，输出润色后的文本，并可查看修改对比。",
    when: "论文初稿写完后，想提升语言表达的学术性和流畅度，或者投稿前想再打磨一遍语言时。",
    steps: [
      "点击左侧「论文润色」进入功能页",
      "选择语言（中文/English）、学科领域和润色强度（轻度/中度/深度）",
      "在左侧文本框粘贴论文内容，点击「开始润色」",
      "右侧流式显示润色结果，可点击「查看修改对比」高亮显示改动之处",
    ],
    tip: "单次最多支持 15000 字，超出请分段润色；润色不会改变原文的观点、数据和引用标注。",
  },
  {
    icon: "👤",
    title: "我的科研档案",
