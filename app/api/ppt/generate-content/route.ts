...
export interface ContentSlide {
  type: "content";
  title: string;
  paragraphs: string[]; // 1-2 段完整段落，含具体数据，每段不超过 150 字
  notes: string;
}
...
4. content（普通内容页，1-2段完整段落，不要用列表，内容要充实）
{ "type": "content", "title": "硅基负极材料的挑战", "paragraphs": ["硅作为锂离子电池负极材料，理论比容量高达4200 mAh/g，是商业化石墨（372 mAh/g）的11倍以上。然而，硅在充放电过程中体积膨胀率高达300%，导致材料粉化、SEI膜反复破裂重组，最终造成容量快速衰减，循环稳定性极差，限制了其商业化应用。", "目前主流的改性策略包括纳米化处理、碳包覆和合金化，但均存在制备工艺复杂、成本高、规模化困难等问题。本研究提出采用高固含量浆料工艺制备纳米硅/碳复合材料，在保证材料性能的同时大幅降低制备成本。"], "notes": "重点讲硅的容量优势和体积膨胀这个核心矛盾" }
