...
card 版式（内容有 2-3 个并列子主题）：
{ "type": "content", "layout": "card", "title": "研究方法概述", "paragraphs": [], "cards": [
  { "heading": "材料制备", "points": ["• 高固含量浆料（100 mg/mL）制备纳米硅/碳复合材料，固含量是传统的5倍", "• 喷雾干燥造粒后，D50粒径控制在150 nm，分布均匀"] },
  { "heading": "结构表征", "points": ["• SEM观察颗粒形貌，XRD确认碳包覆结晶度（IG/ID = 1.2）", "• BET测定比表面积，评估颗粒团聚程度"] },
  { "heading": "电化学测试", "points": ["• 0.1–5C倍率循环，评估容量和倍率性能", "• EIS阻抗谱分析SEI膜厚度与界面阻抗变化"] }
], "notes": "介绍三步核心方法，重点讲高固含量是本文方法的关键创新" }
